...
class System:
    ...
    async def connect(self, system_address=None, name=''):
        """
        ...
        if self._mavsdk_server_address is None:
            ...
            self._start_mavsdk_server(system_address, name, self._port)
    ...
    @staticmethod
    def _start_mavsdk_server(system_address=None, name='', port=50051):
        """
        ...
        try:
            with path(bin, 'mavsdk_server'+name) as backend:
