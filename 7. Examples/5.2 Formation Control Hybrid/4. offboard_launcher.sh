...
height+=("0.222")
num_rotors+=("4")
thrust_curve+=("intel_aero")

comm_library+=("mavros")
program_name+=("leader.py")
program_args+=("5.5 5.5 0.35")
optitrack_pose_forwarder+=("aero2")
neighborhood+=("")
offboard_logs+=("yes")
real_time_monitor+=("")
...
comm_library+=("mavros")
program_name+=("follower.py")
program_args+=("4 2 0.25 1.5707")
optitrack_pose_forwarder+=("aero3")
neighborhood+=("uav1 uav4")
offboard_logs+=("yes")
real_time_monitor+=("pos")
visualization_tool+=("python")
...
comm_library+=("mavros")
program_name+=("follower.py")
program_args+=("4 2 0.25 3.665")
optitrack_pose_forwarder+=("")
neighborhood+=("uav1 uav2")
offboard_logs+=("yes")
real_time_monitor+=("")
visualization_tool+=("python")
...
comm_library+=("mavros")
program_name+=("follower.py")
program_args+=("4 2 0.25 -0.5236")
optitrack_pose_forwarder+=("")
neighborhood+=("uav1 uav3")
offboard_logs+=("yes")
real_time_monitor+=("")
visualization_tool+=("python")
